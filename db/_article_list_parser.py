...
from db.models import ArticleList
import time
...
def parse_article_list():
    try:
        print("Starting article list scrape")
        for weburl in jambase:
            ...
            pagectr = 0
            while nextpage == True:
                print("Scraping: " + weburl + " pagectr = " + str(pagectr))
            ...
            for url in article_list:
                ...
                if len(qs) <= 0:
                    print("Inserting article url: " + url + " into database")
